...
#| exercise: ex_5
biopicsArt <- biopics %>%
  filter(_______ %in% c("_____", "______", "______")
...
```{webr}
#| exercise: ex_6
filteredBiopics <- filter(______, _______)
...
biopics2 <- mutate(paste(______, ______))
